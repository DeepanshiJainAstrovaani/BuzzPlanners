...
// import { getTravelPackageById } from '@/api/getTravelPackages';
...
export default function TravelPackageDetailsPage() {
  ...
  return (
    <div className="bg-app">
      ...
      <div className="container my-3 my-md-5" style={{ fontFamily: "'Inter', 'Segoe UI', Arial, sans-serif" }}>
        {/* Breadcrumb */}
        <div className="mb-2 text-success" style={{ fontWeight: 500, fontSize: 'clamp(12px, 2vw, 13px)' }}>
          Home &gt; Holidays &gt; Thailand
        </div>
        {/* Title and tags */}
        <h2
          className="mb-2"
          style={{ fontWeight: 700, fontSize: 'clamp(18px, 4vw, 22px)', color: '#212529' }}
        >
          {pkg.title}
        </h2>
        ...
        {/* Images carousel */}
        <Carousel className="mb-4" style={{ borderRadius: 10, overflow: 'hidden' }}>
          {pkg.images.map((img: string | Blob | undefined, i: React.Key | null | undefined) => (
            <Carousel.Item key={i}>
              <img src={img} alt="Package" className="d-block w-100" style={{ maxHeight: 'clamp(200px, 50vw, 400px)', objectFit: 'cover' }} />
            </Carousel.Item>
          ))}
        </Carousel>
        ...
        <div className="row">
          ...
          <div className="col-lg-8 mb-4">
            ...
            >
              ...
              {tabKeys.map((tab) => (
                <button
                  ...
                  onMouseLeave={(e) => {
                    if (activeTab !== tab.key) {
                      e.currentTarget.style.background = '#F2F2F280';
                    }
                  }}
            ...
            <div className='p-2'>
                  ...
                  {pkg.itinerary.map((day: { day: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; details: string[]; images: string[]; }, i: React.Key | null | undefined) => (
                    ...
                    >
                      ...
                      {day.details.map((det: string, d: number) => (
                        <div
                          key={d}
                          style={{ color: '#222222', fontSize: 'clamp(13px, 3vw, 15px)', lineHeight: 1.6, marginLeft: '2%' }}
                        >
                          {det}
                        </div>
                      ))}
                      <div className="d-flex gap-2 my-4" style={{ marginLeft: '2%', marginBottom: '2%', flexWrap: 'wrap' }}>
                        {day.images &&
              ...
              {/* Inclusion Section */}
              <section ref={inclusionRef} id="inclusion-section" style={{ marginTop: 'clamp(20px, 5vw, 32px)' }}>
                <div className="row" style={{ gap: 'clamp(20px, 10vw, 64px)' }}>
                  {/* Inclusions Column */}
                      ...
                      {pkg.inclusions.map((inc: string, i: number) => (
                        <li key={i} style={{
                          ...
                          <span style={{
                            ...
                            marginRight: 'clamp(10px, 3vw, 15px)',
                            flexShrink: 0
                          }}>
                            <svg width="clamp(20px, 5vw, 25px)" height="clamp(20px, 5vw, 25px)" viewBox="0 0 19 19" fill="none">
              ...
              {/* Policy Section */}
              <section ref={policyRef} id="policy-section" style={{ marginTop: 'clamp(20px, 5vw, 32px)' }}>
                <h5
                  style={{
                    fontWeight: 700,
                    fontSize: 'clamp(18px, 4.5vw, 25px)',
                ...
                <ol style={{ paddingLeft: 'clamp(16px, 4vw, 20px)' }}>
                  {pkg.policy.map((rule: string, i: number) => (
                    <li key={i} style={{ 
                      color: 'rgb(34, 34, 34)', 
                      fontSize: 'clamp(14px, 3.5vw, 17.5px)',
                      lineHeight: 1.6,
          ...
          <div className="col-lg-4">
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = '#1e8f5a';
                  e.currentTarget.style.transform = 'translateY(-1px)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = '#24a86b';
