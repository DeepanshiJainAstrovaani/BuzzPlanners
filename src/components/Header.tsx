				...
				<Row className="align-items-center justify-content-between g-2">
					...
					{!isLoginPage && (
						<Col xs="auto" className="ms-auto text-end">
							...
							<div className="d-flex align-items-center justify-content-end gap-2 mt-1 flex-row flex-wrap">
								<Link
									href="#"
								...
								>
									...
									<span className="d-inline d-sm-none" style={{ fontSize: 11 }}>Vendor</span>
								</Link>
